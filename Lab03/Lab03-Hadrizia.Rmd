...
TP <- test_data %>% filter(situacao_final == "eleito", predicao == "nao_eleito") %>% nrow()
TN <- test_data %>% filter(situacao_final == "Bad" , predicao == "nao_eleito" ) %>% nrow()
FP <- test_data %>% filter(situacao_final == "Bad" , predicao == "Good") %>% nrow() 
FN <- test_data %>% filter(situacao_final == "eleito", predicao == "Bad" ) %>% nrow()
```
