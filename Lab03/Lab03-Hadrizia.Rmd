...
train_data <- train_data %>% select(-descricao_ocupacao, -recursos_de_outros_candidatos.comites, -recursos_de_partidos, -recursos_de_pessoas_fÃ.sicas, -recursos_de_pessoas_juridicas, -recursos_proprios)
...
No treino, o modelo teve acurácia igual a X; na validação, esse valor diminuiu/aumentou .......
...
#removendo descricao_ocupacao do treino e da validação
rose_train <- rose_train %>% select(-descricao_ocupacao)
test_data <- test_data %>% select(-descricao_ocupacao)
...
No modelo de Regressão Logística, os atributos parecem ser mais importantes. 
...
No modelo de Árvore de Decisão, os atributos XYWMSSM parecem ser mais importantes.
