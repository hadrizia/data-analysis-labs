...
Para responder a esta pergunta, iremos observar a correlação entre todas as variáveis e a quantidade de votos, o valor p (probabilidade da correlação ser aleatória) e r² (porcentagem das variáveis explicarem o voto).
