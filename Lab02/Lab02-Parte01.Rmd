...
#corrgram(input, order=TRUE, lower.panel=panel.shade,
#  upper.panel=panel.pie, text.panel=panel.txt,
#  main="Correlograma das variáveis")
...
```
  ...
  O resultado é o melhor modelo de subconjuntos de todo tamanho começando em 1 variável até 15, que é o número total de variáveis. A seguir precisamos saber qual é o melhor modelo entre estes e o critério de escolha será o R² ajustado, que define o quanto as variáveis 
explicam os votos.
...
```
  ...
  A função acima procura, entre todos os modelos dos subconjuntos das variáveis, qual o modelo que possui maior R² ajustado (nesse caso, 
foi o modelo com todas as variáveis). Observaremos que não existe variável redundante:
